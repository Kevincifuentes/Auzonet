...
var opciones = myApp.controller('OpcionesController', ['$scope', '$routeParams', '$http', function ($scope, $routeParams, $http) {
        ...
        $scope.saveForm = function (user) {
            ...
            //Comprobar password
            console.log("User..." + $scope.user.contrasena);
            if($scope.user.contrasena === $scope.user.repcontrasena)
            {
